...
/*   Updated: 2023/02/28 22:49:44 by pmarquis         ###   lausanne.ch       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void	_copy(char *p, const char *that)
{
	while (*that)
		*p++ = *that++;
}
...
/**
 *	\brief	Replace all occurrences of 'this' found in 's' by 'that'.
 *	\param[in,out] s	String to modify.
 *	\param[in] this		Text to replace.
 *	\param[in] that		Text to insert.
 *	\return				Modified string, or null on memory error.
 */
