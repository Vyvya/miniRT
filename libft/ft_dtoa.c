...
/**
 *	\brief		Mildly acceptable double to string conversion.
 *	\param[in] d	A double to convert to string.
 *	\param[in] precision	How many digits after point.
 *	\param[out] ret			Address wide-enough to store the resulting string.
